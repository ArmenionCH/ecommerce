...
export function CartItemRow({ item, onUpdateQty, onRemove }: CartItemRowProps) {
  ...
  return (
    <div className="flex items-center gap-4 py-4 border-b border-gray-100 last:border-0 animate-in fade-in-50 duration-200">
      {/* Thumbnail */}
      <div className="w-16 h-16 bg-emerald-50/20 rounded-xl overflow-hidden flex-shrink-0 border border-gray-50 flex items-center justify-center">
        {product.image_url ? (
